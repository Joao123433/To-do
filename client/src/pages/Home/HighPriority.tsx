...
import { UseHighPriorityTasks } from "../../hooks/UseHighPriorityTasks";
...
export function HighPriority() {
  ...
  const {taskHighPriority} = UseHighPriorityTasks()
