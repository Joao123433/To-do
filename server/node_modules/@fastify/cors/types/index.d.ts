...
type FastifyCorsPlugin = FastifyPluginCallback<
	...
	| fastifyCors.FastifyCorsOptionsDelegate
>;
...
declare namespace fastifyCors {
	...
	export type AsyncOriginFunction = (
		origin: string | undefined,
	) => Promise<ValueOrArray<OriginType>>;
	...
	export interface FastifyCorsOptions {
		 ...
		 */
		origin?:
			| ValueOrArray<OriginType>
			| fastifyCors.AsyncOriginFunction
			| fastifyCors.OriginFunction;
		/**
	...
	export type FastifyCorsOptionsDelegateCallback = (
		req: FastifyRequest,
		cb: (error: Error | null, corsOptions?: FastifyCorsOptions) => void,
	) => void;
	export type FastifyCorsOptionsDelegatePromise = (
		req: FastifyRequest,
	) => Promise<FastifyCorsOptions>;
	export type FastifyCorsOptionsDelegate =
		| FastifyCorsOptionsDelegateCallback
		| FastifyCorsOptionsDelegatePromise;
	export type FastifyPluginOptionsDelegate<T = FastifyCorsOptionsDelegate> = (
