...
var get_all_priorities_exports = {};
__export(get_all_priorities_exports, {
  getAllPrioritiesRouter: () => getAllPrioritiesRouter
});
module.exports = __toCommonJS(get_all_priorities_exports);
...
// src/http/routes/get-all-priorities.ts
var getAllPrioritiesRouter = async (app) => {
