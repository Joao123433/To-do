...
var get_all_status_exports = {};
__export(get_all_status_exports, {
  getAllStatusRoute: () => getAllStatusRoute
});
module.exports = __toCommonJS(get_all_status_exports);
...
// src/http/routes/get-all-status.ts
var getAllStatusRoute = async (app) => {
